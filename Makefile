...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		src/controllers/mainwindow.h src/main.cpp \
		src/controllers/ClassDiagramController.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/main.cpp src/controllers/ClassDiagramController.cpp src/controllers/mainwindow.cpp $(DISTDIR)/
...
ui_classDiagram_view.h: src/views/classDiagram_view.ui \
		/usr/bin/uic
	/usr/bin/uic src/views/classDiagram_view.ui -o ui_classDiagram_view.h

ui_mainwindow.h: src/views/mainwindow.ui \
		/usr/bin/uic
	/usr/bin/uic src/views/mainwindow.ui -o ui_mainwindow.h
