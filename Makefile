...
# Template: app
# Command: /usr/bin/qmake -o Makefile CPP_Project.pro
#############################################################################
...
SOURCES       = main.cpp \
		...
		ClassDiagram.cpp \
		Mess.cpp \
		SequenceDiagram.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		Element.o \
		UMLAttribute.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		CPP_Project.pro mainwindow.h main.cpp \
		mainwindow.cpp \
		Element.cpp \
		UMLAttribute.cpp \
		UMLOperation.cpp \
...
CPP_Project: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: CPP_Project.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp mainwindow.cpp Element.cpp UMLAttribute.cpp UMLOperation.cpp UMLClassInterfaceTemplate.cpp UMLInterface.cpp UMLRelation.cpp UMLClass.cpp ClassDiagram.cpp Mess.cpp SequenceDiagram.cpp $(DISTDIR)/
...
Element.o: Element.cpp UMLClass.hpp \
...
UMLAttribute.o: UMLAttribute.cpp UMLAttribute.hpp \
		Element.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UMLAttribute.o UMLAttribute.cpp

UMLOperation.o: UMLOperation.cpp UMLOperation.hpp \
		UMLAttribute.hpp \
		Element.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UMLOperation.o UMLOperation.cpp

UMLClassInterfaceTemplate.o: UMLClassInterfaceTemplate.cpp UMLClassInterfaceTemplate.hpp \
		UMLOperation.hpp \
		UMLAttribute.hpp \
		Element.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UMLClassInterfaceTemplate.o UMLClassInterfaceTemplate.cpp

UMLInterface.o: UMLInterface.cpp UMLInterface.hpp \
		UMLClassInterfaceTemplate.hpp \
		UMLOperation.hpp \
		UMLAttribute.hpp \
		Element.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UMLInterface.o UMLInterface.cpp

UMLRelation.o: UMLRelation.cpp UMLRelation.hpp \
		UMLClassInterfaceTemplate.hpp \
		UMLOperation.hpp \
		UMLAttribute.hpp \
		Element.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UMLRelation.o UMLRelation.cpp

UMLClass.o: UMLClass.cpp UMLClass.hpp \
		UMLClassInterfaceTemplate.hpp \
		UMLOperation.hpp \
		UMLAttribute.hpp \
		Element.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o UMLClass.o UMLClass.cpp

ClassDiagram.o: ClassDiagram.cpp ClassDiagram.hpp \
		UMLClassInterfaceTemplate.hpp \
		UMLOperation.hpp \
		UMLAttribute.hpp \
		Element.hpp \
		...
		UMLClass.hpp \
		UMLInterface.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ClassDiagram.o ClassDiagram.cpp

Mess.o: Mess.cpp Mess.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Mess.o Mess.cpp

SequenceDiagram.o: SequenceDiagram.cpp SequenceDiagram.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SequenceDiagram.o SequenceDiagram.cpp
