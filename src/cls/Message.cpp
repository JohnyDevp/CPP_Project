...
Message::Message(int Ycoord, QString classSender, QString classReceiver, UMLOperation umlOperation, MessageType messageType) : Ycoord(Ycoord), classSender(classSender), classReceiver(classReceiver), operation(umlOperation), messageType(messageType){};
